...
const I18N = {
  de: {
    ...
    legendTitle: "Anteil pünktlicher Halte",
    legendLow: "unter 50 %",
    legendHigh: "100 %",
    asOf: "Stand: {date} · jeden Morgen automatisch aktualisiert",
    podiumHeading: "Das Podium · die pünktlichsten Bahnen",
    podiumNote: "Gewertet werden Fernzüge",
    ...
    mapLabel: "Karte Europas: Länder nach Anteil pünktlicher Halte eingefärbt, das pünktlichste Land hervorgehoben",
    ...
    ctaStat: "{pct} der Fernzüge in Deutschland sind verspätet.",
  ...
  en: {
    ...
    legendTitle: "Share of stops on time",
    legendLow: "under 50%",
    legendHigh: "100%",
    asOf: "Data as of {date} · refreshed automatically every morning",
    podiumHeading: "The podium · most punctual railways",
    podiumNote: "Ranked on long-distance trains",
    ...
    mapLabel: "Map of Europe, countries shaded by their share of stops on time, the most punctual one outlined in gold",
    ...
    ctaStat: "{pct} of long-distance trains in Germany run late.",
